...
from apan import AtlasApan
import support
from async_trainer import AsyncPipelineTrainer, configure_cpu_threads


parser = argparse.ArgumentParser(description="Async TGN trainer with CUDA Graph support")
...
parser.add_argument('--n-layers', type=int, default=1, help='number of layers (default: 2)')
parser.add_argument('--n-heads', type=int, default=2, help='number of attention heads (default: 2)')
parser.add_argument('--n-nbrs', type=int, default=10, help='number of neighbors to sample (default: 20)')
parser.add_argument('--mail-slots', type=int, default=10, help='number of mail slots (default: 10)')
...
model_path = support.make_model_path('apan-async', args.prefix, args.data)
model_mem_path = support.make_model_mem_path('apan-async', args.prefix, args.data)
if args.seed >= 0:
