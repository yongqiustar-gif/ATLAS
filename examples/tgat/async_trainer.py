...
class AsyncPipelineTrainer:
    """Encapsulates the async dataloading + CUDA Graph TGAT training loop."""
    ...
    def __init__(
        ...
        *,
        ...
        self.labels_static: Optional[torch.Tensor] = None
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.epochs):
            ...
            print(f"  epoch time:{tt.t_epoch:.2f}s")

            _nvtx_pop()
            _nvtx_push("validation")
    ...
    def _prepare_cuda_graph(self) -> None:
        ...
        for _ in range(self.warmup_steps):
            self._copy_gpu_block_into_static(dummy_gpu_block, self.static_block)
    ...
    @staticmethod
    def _cpu_stage(
        cpu_queue_obj: "queue.Queue[Optional[at.AtlasCPUBlock]]",
        *,
        g: at.TGraph,
        start_idx: int,
        end_idx: int,
    ...
    @staticmethod
    def _copy_gpu_block_into_static(src: at.AtlasGPUBlock, dst: at.AtlasGPUBlock) -> None:
...
class AsyncPipelineTrainerIndex:
    """Encapsulates the async dataloading + CUDA Graph TGAT training loop."""
