...
parser.add_argument('--n-nbrs', type=int, default=1, help='number of neighbors to sample (default: 20)')
...
model_path = support.make_model_path('jodie-async', args.prefix, args.data)
model_mem_path = support.make_model_mem_path('jodie-async', args.prefix, args.data)
if args.seed >= 0:
