...
model_path = support.make_model_path('tgn-async', args.prefix, args.data)
model_mem_path = support.make_model_mem_path('tgn-async', args.prefix, args.data)
if args.seed >= 0:
